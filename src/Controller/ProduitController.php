...
class ProduitController extends AbstractController
{
    ...
    /**
     * @Route("/admin/produit/ajouter", name="produit_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/admin/produit/{id}/modifier", name="produit_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/produit/fiche/{reference}", name="fiche_produit", methods={"GET"})
     */
    public function fiche(ProduitRepository $pr, $reference): Response
    {
        $produit = $pr->findOneBy([ "reference" => $reference ]);
        if($produit){
            return $this->render('produit/fiche.html.twig', [ 'produit' => $produit ]);
        }
        else {
